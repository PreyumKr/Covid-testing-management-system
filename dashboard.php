...
<?php 
//Total tests
$query=mysqli_query($con,"select Slno from tbltestrecord");
$totaltest=mysqli_num_rows($query);
//Assigned tests
$query1=mysqli_query($con,"select Slno from tbltestrecord where Reportstat='Assigned'");
$totalassigned=mysqli_num_rows($query1);
//On the way for sample collection
$query2=mysqli_query($con,"select Slno from tbltestrecord where Reportstat='On the Way for Collection'");
$totalontheway=mysqli_num_rows($query2);
//Sample Collected
$query3=mysqli_query($con,"select Slno from tbltestrecord where Reportstat='Sample Collected'");
$totalsamplecollected=mysqli_num_rows($query3);
//Sent for lab
$query4=mysqli_query($con,"select Slno from tbltestrecord where Reportstat='Sent to Lab'");
$totalsenttolab=mysqli_num_rows($query4);

//Report Delivered
$query5=mysqli_query($con,"select Slno from tbltestrecord where Reportstat='Delivered'");
$totaldelivered=mysqli_num_rows($query5);

//Totall Registered Patients 
$query6=mysqli_query($con,"select Slno from tblpatients");
