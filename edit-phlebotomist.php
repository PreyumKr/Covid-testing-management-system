...
$query="update tblphlebotomist set FN='$fname',Phno='$mnumber' where id='$pid'";
...
?>                 
<h1 class="h3 mb-4 text-gray-800"><?php echo $row['FN'];?>'s Profile</h1>
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Enter your full name..." pattern="[A-Za-z ]+" title="letters only" value="<?php echo $row['FN'];?>" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Mobile Number</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{10}" title="10 numeric characters only" value="<?php echo $row['Phno'];?>" required="true" >
